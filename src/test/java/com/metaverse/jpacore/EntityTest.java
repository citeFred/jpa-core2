...
public class EntityTest {
    ...
    void test_transaction_1() {
        ...
        try {
            ...
            em.persist(memo); // EntityManager 가 memo 객체를 영속성 컨텍스트에 저장한다.
    ...
    void test9() {
        ...
        try {
            ...
            System.out.println("em.contatins(foundMemo) = " + em.contains(foundMemo));
            ...
            // em.close();
            // 영속성 컨텍스트 자체를 닫는 기능 -> 관리되던 엔터티들은 모두 준영속으로 해제 됨
            // em.merge(foundMemo)
            // 준영속 상태에서 다시 영속 상태로 바꿈
            System.out.println("em.contatins(foundMemo) = " + em.contains(foundMemo));
